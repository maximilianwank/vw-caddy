...
mv filter_vaultwarden-user.local /etc/fail2ban/filter.d/vaultwarden-user.local
...
mv jail_vaultwarden-user.local /etc/fail2ban/jail.d/vaultwarden-user.local
...
mv filter_vaultwarden-admin.local /etc/fail2ban/filter.d/vaultwarden-admin.local
...
mv jail_vaultwarden-admin.local /etc/fail2ban/jail.d/vaultwarden-admin.local
